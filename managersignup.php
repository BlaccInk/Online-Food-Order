<html>
  ...
  <head>
    <title> Manager Signup | Kasi Flava </title>
  </head>
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Kasi Flava</a>
        </div>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Manager, <br> Welcome to <span class="edit"> Kasi Flava </span></h1>
     <br>
  ...
  <br>
  <p> Kasi Flava 2020 | &copy All Rights Reserved </p>
  <br>
  </footer>
</html>